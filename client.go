...
// FixAPI struct provide communication with equities services
type FixAPI struct {
...
func NewFixAPI(sessionCfgPath string, respChanMaxSize int) (FixAPI, error) {
	...
	application := Application{respChan}
	if initiator, err = quickfix.NewInitiator(application, fileStoreFactory,
